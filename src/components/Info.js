    ...
    return(
        <section className="secOne">
            ...
            <div className="card--details">
                ...
                <small className="person-website">faithmutitu.website</small>
            </div>
            <div className="socials-buttons">
                <button className="email-btn">
                    <svg className="email--icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                ...
                <button className="linkedln-btn">
                    ...
                    <span className="linkedin--name">linkedin</span>
                </button>
            </div>
        </section>
    );
